...
Antworte NUR im JSON-Format:
{
  ...
  "primary_keyword": "...",
  "social_text": "...",
  "image_prompt_1": "English image prompt for the title image. Use the company's industry (${profile?.industry || "business"}), region (${profile?.region || ""}), and article topic. Photorealistic, no text, no faces, no logos. Max 120 chars. Describe a concrete scene/mood matching the article.",
  "image_format_1": "landscape OR portrait OR square — choose based on article mood: landscape=wide scenes/overviews, portrait=people/buildings/details, square=objects/products",
  ...
  "image_format_2": "landscape OR portrait OR square — usually different from image_format_1 for visual variety",
  "chart_config": null
}
