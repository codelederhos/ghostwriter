...
<div class="cta-block">
  ...
  <a href="${profile?.website_url || '#'}" class="cta-block__btn" target="_blank" rel="noopener">Jetzt kostenlos anfragen →</a>
</div>
(Linktext passend zum Unternehmen anpassen, website_url als href)
