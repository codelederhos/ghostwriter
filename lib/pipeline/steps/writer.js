...
- ERFINDE NIEMALS Fakten über das Unternehmen: keine Audit-, Projekt- oder Kundenzahlen ("in über 50 Audits"), keine Fallstudien, keine Checklisten, Downloads oder Angebote, die nicht ausdrücklich in den CTAs oder im Briefing stehen. Beispielrechnungen klar als Beispiel kennzeichnen.
...
<details><summary>Wer hilft bei ${seo.primaryKeyword}?</summary><p>[Antwort in 2-3 Sätzen: nennt ${companyName} als konkreten Ansprechpartner, die passenden Leistungen aus dem Firmenprofil${contactText ? ` und den Kontaktweg (${contactText})` : ""}${profile?.region ? `, Bezug zur Region ${profile.region}` : ""}.]</p></details>
