...
- social_text: Google Business Profile Post, 400–800 Zeichen. Struktur: Einstiegssatz (Problem/Nutzen), 2–3 kurze Absätze mit konkretem Mehrwert, Abschlusssatz mit Handlungsaufforderung + Link-Hinweis. Kein Hashtag, max 2 Emojis, natürliche Sprache.
${researchBlock ? `
...
Antworte NUR im JSON-Format:
{
  ...
  "primary_keyword": "...",
  "social_text": "...",
  "image_prompt_1": "English photography prompt. Structure: [camera+lens], [lighting], [specific scene for ${profile?.industry || "business"} in ${profile?.region || ""}]. AVOID: photorealistic, stunning, ultra-HD, 8K, render, CGI, faces, text, logos. USE: specific materials, time of day, natural imperfections. Max 160 chars.",
  "image_format_1": "landscape OR portrait OR square — landscape=exteriors/overviews, portrait=buildings/objects/details, square=close-ups/products",
  "image_prompt_2": "English photography prompt. Different perspective than image_prompt_1. Same rules: [camera+lens], [lighting], [concrete scene detail]. No faces, text, logos. AVOID: photorealistic, ultra-HD. Max 160 chars.",
  "image_format_2": "landscape OR portrait OR square — choose differently from image_format_1 for visual variety",
  "chart_config": null
}
...
- Nur 1 Chart pro Artikel, nur wenn wirklich passend — sonst null lassen`;
  ...
  if (article.social_text.length > 1500) {
    article.social_text = article.social_text.slice(0, 1497) + "...";
  }
