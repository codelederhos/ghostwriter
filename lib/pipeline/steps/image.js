...
export async function runImageGen(settings, article, seo, plan = {}, tenantId = null, referenceImageUrls = []) {
  const style = settings.image_style_prefix || "Shot on Canon 5D Mark IV 35mm f/2.8, golden hour natural light, Kodak Portra 400 film grain, authentic atmosphere, no faces, no text, no logos, no CGI";
