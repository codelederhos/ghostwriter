 ...
 * Beste Preis-Leistung mit großem Kontext, regelmäßig aktualisieren.
 */
const RECOMMENDED_MODELS = {
  anthropic: "claude-sonnet-4-20250514",   // 200k ctx, schnell, günstig
  openai:    "gpt-4o",                      // 128k ctx, beste OpenAI P/L
  mistral:   "mistral-large-latest",        // 128k ctx, EU-hosted
};
...
export async function generateText(settings, systemPrompt, userPrompt) {
  ...
  const model = RECOMMENDED_MODELS[provider] || settings.text_model;
