...
/* Chart Container */
.gw-chart { margin: 2rem 0; border-radius: 12px; border: 1px solid #e5e7eb; padding: 1.5rem 1.25rem; background: #fafafa; }
.gw-chart canvas { display: block; max-height: 420px; }
.gw-chart script { display: none; }
.gw-chart__title { font-weight: 600; font-size: 0.875rem; line-height: 1.35; margin: 0 0 0.75rem; color: #111827; }
.gw-chart img { display: block; max-width: 100%; height: auto; border-radius: 8px; }
